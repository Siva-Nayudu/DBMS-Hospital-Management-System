			...
			<div class="panel panel-info">
				...
				<div style="padding-top:30px" class="panel-body">
					...
					<form id="loginform" class="form-horizontal" role="form" method="POST" action="">
						...
						<h3>Doctor Login</h3>
						<strong>Email: </strong>naveed@gmail.com<br>
						<strong>Password:</strong> 123<br>
						<strong>Email: </strong>siva@gmail.com<br>
						<strong>Password:</strong> 123

						<h3>Patient Login</h3>
						<strong>Email: </strong>shivang@gmail.com<br>
						<strong>Password:</strong> 123
						<br>
						<strong>Email: </strong>alex@gmail.com<br>
						<strong>Password:</strong> 123
						</p>
